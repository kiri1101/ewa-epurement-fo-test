...
import script$1 from './index-DtJ-nEHD.mjs';
...
import { c as useNuxtApp, d as useI18n, e as useAuthStore, u as useHead, f as useRuntimeConfig, _ as _export_sfc } from './server.mjs';
import { _ as __nuxt_component_7 } from './Primary-TsiIkHTo.mjs';
import script from './index-CANWmNzI.mjs';
import { u as useNotify } from './notify-Das_t6BJ.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mx-auto w-92" }, _attrs))}><h2 class="pb-4 text-3xl font-bold text-center underline decoration-auth-form-title-decoration decoration-2 underline-offset-10 text-auth-text-primary">${ssrInterpolate(_ctx.$t("page.login.form_title"))}</h2><p>${ssrInterpolate(_ctx.$t("page.login.intro_msg.part1"))} <span class="font-semibold">${ssrInterpolate(_ctx.$t("page.login.intro_msg.part2"))}</span> ${ssrInterpolate(_ctx.$t("page.login.intro_msg.part3"))}</p><form class="mt-4 space-y-4"><div>`);
...
//# sourceMappingURL=signin-BKS-jrA7.mjs.map
