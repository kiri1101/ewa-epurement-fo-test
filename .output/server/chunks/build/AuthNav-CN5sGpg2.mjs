  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<i${ssrRenderAttrs(mergeProps({
        class: [
          "bg-button-main hover:bg-button-main-hover p-1.5 rounded cursor-pointer text-button-main-label hover:text-button-main-hover-label",
          __props.icon
        ],
...
const __nuxt_component_1 = Object.assign(_sfc_main$1, { __name: "ButtonIcon" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_button_icon = __nuxt_component_1;
...
//# sourceMappingURL=AuthNav-CN5sGpg2.mjs.map
