import { V as executeAsync } from '../_/nitro.mjs';
import { w as defineNuxtRouteMiddleware, x as useCookie, n as navigateTo, e as useRuntimeConfig } from './server.mjs';
import 'drizzle-orm';
import 'moment';
...
const authenticated = defineNuxtRouteMiddleware(async (to, from) => {
  ...
  if (to.name === "dashboard" && authStoreRef.value) {
    if (authStoreRef.value.state.firstAttempt) {
      [__temp, __restore] = executeAsync(() => $fetch(config.public.api.logout, {
...
//# sourceMappingURL=authenticated-BP3u6547.mjs.map
