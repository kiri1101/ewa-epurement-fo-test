...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const pt = {
      root: {
        class: "w-full px-4 py-2 h-9 placeholder-text-muted focus:outline-none peer",
...
const __nuxt_component_6 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-69c0abc2"]]), { __name: "InputBgNormal" });

export { __nuxt_component_6 as _ };
//# sourceMappingURL=BgNormal-WNDX37G3.mjs.map
