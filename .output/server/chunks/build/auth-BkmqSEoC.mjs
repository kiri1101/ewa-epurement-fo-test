...
import { a as useAssetStore, b as __nuxt_component_6, _ as _export_sfc } from './server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(showLoader).hero) {
        _push(`<div class="w-64 h-96 lg:w-96">`);
        _push(ssrRenderComponent(_component_skeleton, {
          width: "100%",
          height: "100%"
        }, null, _parent));
...
//# sourceMappingURL=auth-BkmqSEoC.mjs.map
