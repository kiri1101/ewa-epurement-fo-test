...
import { _ as __nuxt_component_2$1 } from './BgTransparent-CGRZlmqn.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_input_bg_transparent = __nuxt_component_2$1;
...
//# sourceMappingURL=infos-BvQf1oxt.mjs.map
