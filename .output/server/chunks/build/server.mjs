...
import { mergeProps, defineComponent, ref, inject, h, Suspense, hasInjectionContext, readonly, useId, Fragment, computed, getCurrentInstance as getCurrentInstance$1, nextTick, watch, provide, shallowReactive, shallowRef, createElementBlock, cloneVNode, defineAsyncComponent, unref, createApp, createVNode, Text, renderSlot, openBlock, createBlock, Teleport, createCommentVNode, createElementVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, getCurrentScope, toRef, withCtx, isReadonly, toRaw, useSSRContext, isRef, isShallow, isReactive, resolveDirective, toDisplayString as toDisplayString$1, normalizeProps, withDirectives, resolveComponent, TransitionGroup, renderList, markRaw } from 'vue';
import { o as parseURL, q as encodePath, s as decodePath, j as hasProtocol, t as isScriptProtocol, k as joinURL, v as withQuery, x as klona, y as sanitizeStatusCode, z as getRequestHeader, A as destr, B as isEqual, C as getContext, D as setCookie, E as getCookie, F as deleteCookie, $ as $fetch$1, G as baseURL, H as createHooks, c as createError$1, I as defu, n as executeAsync, J as getRequestURL, K as createDefu, L as parsePath, i as parseQuery, m as withoutTrailingSlash } from '../_/nitro.mjs';
...
import { getKeyValue, resolve, minifyCSS, isNotEmpty, isEmpty, isString as isString$1, isArray as isArray$1, toFlatCase, isFunction as isFunction$1, toCapitalCase, isObject as isObject$1, equals, removeAccents, resolveFieldData } from '@primeuix/utils/object';
import { style } from '@primeuix/styles/base';
import { findSingle, isElement, getAttribute, removeClass, getHeight, getWidth, getOuterWidth, getOuterHeight, getOffset, addClass, createElement, hasClass, getViewport, getWindowScrollLeft, getWindowScrollTop, isExist, fadeIn, isTouchDevice, isClient, setAttributes, setAttribute, getScrollableParents } from '@primeuix/utils/dom';
...
const _routes = [
  {
    name: "auth",
    path: "/auth",
    component: () => import('./auth-C4wCY9hL.mjs'),
    children: [
      {
        name: "auth-signin",
        path: "signin",
        meta: { "middleware": ["guest"] },
        component: () => import('./signin-BfSF6Ohs.mjs')
      },
      {
        name: "auth-forgot-password",
        path: "forgot-password",
        meta: { "middleware": ["authenticated"] },
        component: () => import('./forgot-password-DFlhC9D4.mjs')
      },
      {
        name: "auth-update-password",
        path: "update-password",
        meta: { "middleware": ["authenticated"] },
        component: () => import('./update-password-DE5R3aqW.mjs')
      }
    ]
  },
  {
    name: "user",
    path: "/user",
    component: () => import('./user-BhK9eooh.mjs'),
    children: [
      {
        name: "user-profile",
        path: "profile",
        meta: { ...__nuxt_page_meta$c || {}, ...{ "middleware": ["authenticated"] } },
        component: () => import('./profile-CUxF3t23.mjs'),
        children: [
          {
            name: "user-profile-infos",
            path: "infos",
            component: () => import('./infos-CkcyHtr6.mjs')
          },
          {
            name: "user-profile-collaborators",
            path: "collaborators",
            component: () => import('./collaborators-DEPLNOxl.mjs')
          }
        ]
      }
    ]
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-C3wWQ-Tj.mjs')
  },
  {
    name: "accounts",
    path: "/accounts",
    meta: { ...__nuxt_page_meta$b || {}, ...{ "middleware": ["authenticated"] } },
    component: () => import('./accounts-G_mSZtNC.mjs')
  },
  {
    name: "transfer",
    path: "/transfer",
    component: () => import('./transfer-DPTDvsxA.mjs'),
    children: [
      {
        name: "transfer-list",
        path: "list",
        meta: { ...__nuxt_page_meta$a || {}, ...{ "middleware": ["authenticated"] } },
        component: () => import('./list-DuN8D3gl.mjs')
      },
      {
        name: "transfer-create",
        path: "create",
        meta: { ...__nuxt_page_meta$9 || {}, ...{ "middleware": ["authenticated"] } },
        component: () => import('./create-CcuISXY_.mjs')
      },
      {
        name: "transfer-id-details",
        path: ":id()/details",
        meta: { ...__nuxt_page_meta$8 || {}, ...{ "middleware": ["authenticated"] } },
        component: () => import('./details-DNX5QovQ.mjs')
      }
    ]
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { ...__nuxt_page_meta$7 || {}, ...{ "middleware": ["authenticated"] } },
    component: () => import('./dashboard-CaVf_RhC.mjs')
  },
  {
    name: "beneficiary",
    path: "/beneficiary",
    component: () => import('./beneficiary-5Ecrgiq3.mjs'),
    children: [
      {
        name: "beneficiary-list",
        path: "list",
        meta: { ...__nuxt_page_meta$6 || {}, ...{ "middleware": ["authenticated"] } },
        component: () => import('./list-ynjbWcqc.mjs')
      },
      {
        name: "beneficiary-create",
        path: "create",
        meta: { ...__nuxt_page_meta$5 || {}, ...{ "middleware": ["authenticated"] } },
        component: () => import('./create-CjMKicIz.mjs')
      },
      {
        name: "beneficiary-id-edit",
        path: ":id()/edit",
        meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": ["authenticated"] } },
        component: () => import('./edit-26xgdVL4.mjs')
      }
    ]
  },
  {
    name: "domiciliation",
    path: "/domiciliation",
    component: () => import('./domiciliation-CX-oAEZE.mjs'),
    children: [
      {
        name: "domiciliation-new",
        path: "new",
        meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": ["authenticated"] } },
        component: () => import('./new-XLPEgEyI.mjs')
      },
      {
        name: "domiciliation-list",
        path: "list",
        meta: { ...__nuxt_page_meta$2 || {}, ...{ "middleware": ["authenticated"] } },
        component: () => import('./list-pHHuNej6.mjs')
      },
      {
        name: "domiciliation-id-edit",
        path: ":id()/edit",
        meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": ["authenticated"] } },
        component: () => import('./edit-D1xZn5Il.mjs')
      }
    ]
  },
  {
    ...
    component: () => import('./document-DU5n_JhQ.mjs')
  }
];
...
const namedMiddleware = {
  authenticated: () => import('./authenticated-UeiIsQL-.mjs'),
  guest: () => import('./guest-TBz97los.mjs')
};
...
const LazyAutoComplete = defineAsyncComponent(() => import('./index-zHSHIGEC.mjs').then((r) => r["default"] || r.default || r));
const LazyCalendar = defineAsyncComponent(() => import('./index-PuTpM4B7.mjs').then((r) => r["default"] || r.default || r));
const LazyCascadeSelect = defineAsyncComponent(() => import('./index-AMv4GgR_.mjs').then((r) => r["default"] || r.default || r));
const LazyCheckbox = defineAsyncComponent(() => import('./index-CqJBuwa3.mjs').then((r) => r["default"] || r.default || r));
const LazyCheckboxGroup = defineAsyncComponent(() => import('./index-DkOF2jW2.mjs').then((r) => r["default"] || r.default || r));
const LazyChips = defineAsyncComponent(() => import('./index-DQ16WALb.mjs').then((r) => r["default"] || r.default || r));
const LazyColorPicker = defineAsyncComponent(() => import('./index-DgkktB-l.mjs').then((r) => r["default"] || r.default || r));
const LazyDatePicker = defineAsyncComponent(() => import('./index-UOnup3Dx.mjs').then((r) => r["default"] || r.default || r));
const LazyDropdown = defineAsyncComponent(() => import('./index-bV0wqiDm.mjs').then((r) => r["default"] || r.default || r));
const LazyFloatLabel = defineAsyncComponent(() => import('./index-DDIOzWP2.mjs').then((r) => r["default"] || r.default || r));
const LazyFluid = defineAsyncComponent(() => import('./index-DjQCqNWs.mjs').then((r) => r["default"] || r.default || r));
const LazyIconField = defineAsyncComponent(() => import('./index-DNiohjxC.mjs').then((r) => r["default"] || r.default || r));
const LazyIftaLabel = defineAsyncComponent(() => import('./index-BJdjhwvE.mjs').then((r) => r["default"] || r.default || r));
const LazyInputChips = defineAsyncComponent(() => import('./index-DogN6rng.mjs').then((r) => r["default"] || r.default || r));
const LazyInputGroup = defineAsyncComponent(() => import('./index-EKFMx5kG.mjs').then((r) => r["default"] || r.default || r));
const LazyInputGroupAddon = defineAsyncComponent(() => import('./index-DnjRpD5B.mjs').then((r) => r["default"] || r.default || r));
const LazyInputIcon = defineAsyncComponent(() => import('./index-CicSKTaH.mjs').then((r) => r["default"] || r.default || r));
const LazyInputMask = defineAsyncComponent(() => import('./index-Du8mwQbt.mjs').then((r) => r["default"] || r.default || r));
const LazyInputNumber = defineAsyncComponent(() => import('./index-BjkFAZaV.mjs').then((r) => r["default"] || r.default || r));
const LazyInputOtp = defineAsyncComponent(() => import('./index-BRid2hRl.mjs').then((r) => r["default"] || r.default || r));
const LazyInputSwitch = defineAsyncComponent(() => import('./index-DjDQhJAE.mjs').then((r) => r["default"] || r.default || r));
const LazyInputText = defineAsyncComponent(() => import('./index-DhmvckXO.mjs').then((r) => r["default"] || r.default || r));
const LazyKnob = defineAsyncComponent(() => import('./index-OASS2vAl.mjs').then((r) => r["default"] || r.default || r));
const LazyListbox = defineAsyncComponent(() => import('./index-BT8lEMN5.mjs').then((r) => r["default"] || r.default || r));
const LazyMultiSelect = defineAsyncComponent(() => import('./index-CEolPPF8.mjs').then((r) => r["default"] || r.default || r));
const LazyPassword = defineAsyncComponent(() => import('./index-BoLZap2R.mjs').then((r) => r["default"] || r.default || r));
const LazyRadioButton = defineAsyncComponent(() => import('./index-fnL5HE8b.mjs').then((r) => r["default"] || r.default || r));
const LazyRadioButtonGroup = defineAsyncComponent(() => import('./index-C0E3zJVx.mjs').then((r) => r["default"] || r.default || r));
const LazyRating = defineAsyncComponent(() => import('./index-BOmIipGl.mjs').then((r) => r["default"] || r.default || r));
const LazySelect = defineAsyncComponent(() => import('./index-DeQNdLHz.mjs').then((r) => r["default"] || r.default || r));
const LazySelectButton = defineAsyncComponent(() => import('./index-CMHBph8n.mjs').then((r) => r["default"] || r.default || r));
const LazySlider = defineAsyncComponent(() => import('./index-DOZHssrf.mjs').then((r) => r["default"] || r.default || r));
const LazyTextarea = defineAsyncComponent(() => import('./index-D-7eZ2tE.mjs').then((r) => r["default"] || r.default || r));
const LazyToggleButton = defineAsyncComponent(() => import('./index-BBq-gULa.mjs').then((r) => r["default"] || r.default || r));
const LazyToggleSwitch = defineAsyncComponent(() => import('./index-BwXbREkD.mjs').then((r) => r["default"] || r.default || r));
const LazyTreeSelect = defineAsyncComponent(() => import('./index-H4JBUn5O.mjs').then((r) => r["default"] || r.default || r));
const LazyButton = defineAsyncComponent(() => import('./index-BlaqzKyH.mjs').then((r) => r["default"] || r.default || r));
const LazyButtonGroup = defineAsyncComponent(() => import('./index-BCfuSAMY.mjs').then((r) => r["default"] || r.default || r));
const LazySpeedDial = defineAsyncComponent(() => import('./index-BGbV58SG.mjs').then((r) => r["default"] || r.default || r));
const LazySplitButton = defineAsyncComponent(() => import('./index-HA2Eeas4.mjs').then((r) => r["default"] || r.default || r));
const LazyColumn = defineAsyncComponent(() => import('./index-DqCQSLxI.mjs').then((r) => r["default"] || r.default || r));
const LazyRow = defineAsyncComponent(() => import('./index-DrTUJkkQ.mjs').then((r) => r["default"] || r.default || r));
const LazyColumnGroup = defineAsyncComponent(() => import('./index-CyKTQrl0.mjs').then((r) => r["default"] || r.default || r));
const LazyDataTable = defineAsyncComponent(() => import('./index-CQoIQu5i.mjs').then((r) => r["default"] || r.default || r));
const LazyDataView = defineAsyncComponent(() => import('./index-C5zvjT1L.mjs').then((r) => r["default"] || r.default || r));
const LazyOrderList = defineAsyncComponent(() => import('./index-Cmecn2Pg.mjs').then((r) => r["default"] || r.default || r));
const LazyOrganizationChart = defineAsyncComponent(() => import('./index-D-cZTfYu.mjs').then((r) => r["default"] || r.default || r));
const LazyPaginator = defineAsyncComponent(() => import('./index-BVlmxBjG.mjs').then((r) => r["default"] || r.default || r));
const LazyPickList = defineAsyncComponent(() => import('./index-B8upa6NY.mjs').then((r) => r["default"] || r.default || r));
const LazyTree = defineAsyncComponent(() => import('./index-BE6TGC1b.mjs').then((r) => r["default"] || r.default || r));
const LazyTreeTable = defineAsyncComponent(() => import('./index-CrqxluLH.mjs').then((r) => r["default"] || r.default || r));
const LazyTimeline = defineAsyncComponent(() => import('./index-z5y_PrzR.mjs').then((r) => r["default"] || r.default || r));
const LazyVirtualScroller = defineAsyncComponent(() => import('./index-4S0J0IID.mjs').then((r) => r["default"] || r.default || r));
const LazyAccordion = defineAsyncComponent(() => import('./index-BSwViqAw.mjs').then((r) => r["default"] || r.default || r));
const LazyAccordionPanel = defineAsyncComponent(() => import('./index-C3bcToRo.mjs').then((r) => r["default"] || r.default || r));
const LazyAccordionHeader = defineAsyncComponent(() => import('./index-BEnyDPm8.mjs').then((r) => r["default"] || r.default || r));
const LazyAccordionContent = defineAsyncComponent(() => import('./index-DpXzVJZp.mjs').then((r) => r["default"] || r.default || r));
const LazyAccordionTab = defineAsyncComponent(() => import('./index-hzVbhMuq.mjs').then((r) => r["default"] || r.default || r));
const LazyCard = defineAsyncComponent(() => import('./index-CcIUhuSd.mjs').then((r) => r["default"] || r.default || r));
const LazyDeferredContent = defineAsyncComponent(() => import('./index-xuKH5KrA.mjs').then((r) => r["default"] || r.default || r));
const LazyDivider = defineAsyncComponent(() => import('./index-Cevj7xo8.mjs').then((r) => r["default"] || r.default || r));
const LazyFieldset = defineAsyncComponent(() => import('./index-DvlFk7n1.mjs').then((r) => r["default"] || r.default || r));
const LazyPanel = defineAsyncComponent(() => import('./index-CAcCjQRr.mjs').then((r) => r["default"] || r.default || r));
const LazyScrollPanel = defineAsyncComponent(() => import('./index-C4b2zVGq.mjs').then((r) => r["default"] || r.default || r));
const LazySplitter = defineAsyncComponent(() => import('./index-ZoK-II35.mjs').then((r) => r["default"] || r.default || r));
const LazySplitterPanel = defineAsyncComponent(() => import('./index-Ca4Xc0BP.mjs').then((r) => r["default"] || r.default || r));
const LazyStepper = defineAsyncComponent(() => import('./index-B_MGwOy2.mjs').then((r) => r["default"] || r.default || r));
const LazyStepList = defineAsyncComponent(() => import('./index-EYKzgVRv.mjs').then((r) => r["default"] || r.default || r));
const LazyStep = defineAsyncComponent(() => import('./index-uxD-cfiy.mjs').then((r) => r["default"] || r.default || r));
const LazyStepItem = defineAsyncComponent(() => import('./index-Dp-I5tR-.mjs').then((r) => r["default"] || r.default || r));
const LazyStepPanels = defineAsyncComponent(() => import('./index-CyD91S4n.mjs').then((r) => r["default"] || r.default || r));
const LazyStepPanel = defineAsyncComponent(() => import('./index-BDwPQNYa.mjs').then((r) => r["default"] || r.default || r));
const LazyTabView = defineAsyncComponent(() => import('./index-BBvUZ7Yn.mjs').then((r) => r["default"] || r.default || r));
const LazyTabs = defineAsyncComponent(() => import('./index-BU8XE9xN.mjs').then((r) => r["default"] || r.default || r));
const LazyTabList = defineAsyncComponent(() => import('./index-D4DJpLWU.mjs').then((r) => r["default"] || r.default || r));
const LazyTab = defineAsyncComponent(() => import('./index-BhM7VtzM.mjs').then((r) => r["default"] || r.default || r));
const LazyTabPanels = defineAsyncComponent(() => import('./index-CGnGAzHT.mjs').then((r) => r["default"] || r.default || r));
const LazyTabPanel = defineAsyncComponent(() => import('./index-WCrrdqJu.mjs').then((r) => r["default"] || r.default || r));
const LazyToolbar = defineAsyncComponent(() => import('./index-BaNhBzMz.mjs').then((r) => r["default"] || r.default || r));
const LazyConfirmDialog = defineAsyncComponent(() => import('./index-CSRYns7N.mjs').then((r) => r["default"] || r.default || r));
const LazyConfirmPopup = defineAsyncComponent(() => import('./index-G-OuinTO.mjs').then((r) => r["default"] || r.default || r));
const LazyDialog = defineAsyncComponent(() => import('./index-B8K62pww.mjs').then((r) => r["default"] || r.default || r));
const LazyDrawer = defineAsyncComponent(() => import('./index-Di2rFQU7.mjs').then((r) => r["default"] || r.default || r));
const LazyDynamicDialog = defineAsyncComponent(() => import('./index-Y3eXWJk9.mjs').then((r) => r["default"] || r.default || r));
const LazyOverlayPanel = defineAsyncComponent(() => import('./index-qNBSIQ30.mjs').then((r) => r["default"] || r.default || r));
const LazyPopover = defineAsyncComponent(() => import('./index-DZx4fgBN.mjs').then((r) => r["default"] || r.default || r));
const LazySidebar = defineAsyncComponent(() => import('./index-D3PijYxd.mjs').then((r) => r["default"] || r.default || r));
const LazyFileUpload = defineAsyncComponent(() => import('./index-D8qUZwyU.mjs').then((r) => r["default"] || r.default || r));
const LazyBreadcrumb = defineAsyncComponent(() => import('./index-Se76DgEo.mjs').then((r) => r["default"] || r.default || r));
const LazyContextMenu = defineAsyncComponent(() => import('./index-D5qTcybL.mjs').then((r) => r["default"] || r.default || r));
const LazyDock = defineAsyncComponent(() => import('./index-1jmMw-u6.mjs').then((r) => r["default"] || r.default || r));
const LazyMenu = defineAsyncComponent(() => import('./index-tFR4-0wN.mjs').then((r) => r["default"] || r.default || r));
const LazyMenubar = defineAsyncComponent(() => import('./index-CR5ie7gt.mjs').then((r) => r["default"] || r.default || r));
const LazyMegaMenu = defineAsyncComponent(() => import('./index-CaAo3wwp.mjs').then((r) => r["default"] || r.default || r));
const LazyPanelMenu = defineAsyncComponent(() => import('./index-C9pgRppp.mjs').then((r) => r["default"] || r.default || r));
const LazySteps = defineAsyncComponent(() => import('./index-qBbG83vn.mjs').then((r) => r["default"] || r.default || r));
const LazyTabMenu = defineAsyncComponent(() => import('./index-DZsH19vW.mjs').then((r) => r["default"] || r.default || r));
const LazyTieredMenu = defineAsyncComponent(() => import('./index-CPqL-m79.mjs').then((r) => r["default"] || r.default || r));
const LazyMessage = defineAsyncComponent(() => import('./index-99p4xSP-.mjs').then((r) => r["default"] || r.default || r));
const LazyInlineMessage = defineAsyncComponent(() => import('./index-CkDe6Z_G.mjs').then((r) => r["default"] || r.default || r));
const LazyToast = defineAsyncComponent(() => Promise.resolve().then(() => index).then((r) => r["default"] || r.default || r));
const LazyCarousel = defineAsyncComponent(() => import('./index-D01ZzfWk.mjs').then((r) => r["default"] || r.default || r));
const LazyGalleria = defineAsyncComponent(() => import('./index-CFsCM5Ej.mjs').then((r) => r["default"] || r.default || r));
const LazyImage = defineAsyncComponent(() => import('./index-CFOX7VeO.mjs').then((r) => r["default"] || r.default || r));
const LazyImageCompare = defineAsyncComponent(() => import('./index-CIjrDIYS.mjs').then((r) => r["default"] || r.default || r));
const LazyAvatar = defineAsyncComponent(() => import('./index-Dc3q61gQ.mjs').then((r) => r["default"] || r.default || r));
const LazyAvatarGroup = defineAsyncComponent(() => import('./index-CuOtIcfs.mjs').then((r) => r["default"] || r.default || r));
const LazyBadge = defineAsyncComponent(() => import('./index-DORsLxMh.mjs').then((r) => r["default"] || r.default || r));
const LazyBlockUI = defineAsyncComponent(() => import('./index-C0eSLQ69.mjs').then((r) => r["default"] || r.default || r));
const LazyChip = defineAsyncComponent(() => import('./index-B__8bpse.mjs').then((r) => r["default"] || r.default || r));
const LazyInplace = defineAsyncComponent(() => import('./index-BzB2xLNN.mjs').then((r) => r["default"] || r.default || r));
const LazyMeterGroup = defineAsyncComponent(() => import('./index-DPGq6Uss.mjs').then((r) => r["default"] || r.default || r));
const LazyOverlayBadge = defineAsyncComponent(() => import('./index-Dh_LhKYn.mjs').then((r) => r["default"] || r.default || r));
const LazyScrollTop = defineAsyncComponent(() => import('./index-C603A6KF.mjs').then((r) => r["default"] || r.default || r));
const LazySkeleton = defineAsyncComponent(() => import('./index-CQWGTv9B.mjs').then((r) => r["default"] || r.default || r));
const LazyProgressBar = defineAsyncComponent(() => import('./index-EyclTu7D.mjs').then((r) => r["default"] || r.default || r));
const LazyProgressSpinner = defineAsyncComponent(() => import('./index-CaXPPjyR.mjs').then((r) => r["default"] || r.default || r));
const LazyTag = defineAsyncComponent(() => import('./index-D4bIpu8o.mjs').then((r) => r["default"] || r.default || r));
const LazyTerminal = defineAsyncComponent(() => import('./index-DOjM74m5.mjs').then((r) => r["default"] || r.default || r));
const LazyForm = defineAsyncComponent(() => import('./index-DIKt71sd.mjs').then((r) => r["default"] || r.default || r));
const LazyFormField = defineAsyncComponent(() => import('./index-C_ddXiyY.mjs').then((r) => r["default"] || r.default || r));
  ...
  en: [
    {
      ...
      load: () => import(
        './en-DrkFjimV.mjs'
        /* webpackChunkName: "locale_en_46json_d6c92f75" */
      ),
      cache: true
    }
  ],
  fr: [
    {
      ...
      load: () => import(
        './fr-BWMVVOn0.mjs'
        /* webpackChunkName: "locale_fr_46json_2c1437e4" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/e_q6dGye"}/${locale}/messages.json`, { headers });
...
async function loadAndSetLocale(nuxtApp, locale) {
  ...
  const data3 = { oldLocale, newLocale: locale, initialSetup: ctx.initial, context: nuxtApp };
  let override = await nuxtApp.callHook("i18n:beforeLocaleSwitch", data3);
  if (override != null && false) {
    console.warn("[nuxt-i18n] Do not return in `i18n:beforeLocaleSwitch`, mutate `data.newLocale` instead.");
  }
  override ??= data3.newLocale;
...
function createComposer(options = {}) {
  ...
  function d(...args) {
    return wrapWithDeps((context) => Reflect.apply(datetime, null, [context, ...args]), () => parseDateTimeArgs(...args), "datetime format", (root3) => Reflect.apply(root3.d, root3, [...args]), () => MISSING_RESOLVE_VALUE, (val) => isString(val) || isArray(val));
  }
  function n(...args) {
    return wrapWithDeps((context) => Reflect.apply(number, null, [context, ...args]), () => parseNumberArgs(...args), "number format", (root3) => Reflect.apply(root3.n, root3, [...args]), () => MISSING_RESOLVE_VALUE, (val) => isString(val) || isArray(val));
  }
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/e_q6dGye"}/${locale}/messages.json`));
    ...
    (p) => {
      ...
      return {
        ...
        serializer: p.serializer ?? {
          ...
          deserialize: (data3) => JSON.parse(data3)
        },
...
var BaseStyle = {
  ...
  load: function load(style2) {
    ...
    var computedStyle = transform2(css(_templateObject || (_templateObject = _taggedTemplateLiteral(["", ""])), style2));
...
const apiFetch_ZJUcolkka68DTlFRDIgq2uLlCnEQ6t80BFp5SkRCucE = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  ...
  nuxtApp.provide(
    ...
    $fetch.create({
      ...
      timeout: Number(config.public.app.apiTimeout) ?? 1e4,
      onRequest() {
...
const layouts = {
  connected: defineAsyncComponent(() => import('./connected-BADJ9WMo.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-CvMcoaYX.mjs').then((m) => m.default || m))
};
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    "data-p": $options.dataP
  }, _ctx.ptm("summary")), toDisplayString$1($props.message.summary), 17, _hoisted_3), $props.message.detail ? (openBlock(), createElementBlock("div", mergeProps({
    key: 0,
    "class": _ctx.cx("detail"),
    "data-p": $options.dataP
  }, _ctx.ptm("detail")), toDisplayString$1($props.message.detail), 17, _hoisted_4)) : createCommentVNode("", true)], 16, _hoisted_2)], 64)) : (openBlock(), createBlock(resolveDynamicComponent($props.templates.message), {
    key: 1,
    message: $props.message
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_Toast, _attrs, null, _parent));
}
const _sfc_setup$3 = _sfc_main$3.setup;
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Gadget/ToastNotify.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1]]), { __name: "GadgetToastNotify" });
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_gadget_toast_notify = __nuxt_component_2;
  const _component_NuxtPage = __nuxt_component_0;
  _push(`<!--[-->`);
  _push(ssrRenderComponent(_component_NuxtLoadingIndicator, { color: "var(--color-loading-indicator)" }, null, _parent));
  _push(ssrRenderComponent(_component_NuxtLayout, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_gadget_toast_notify, null, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_NuxtPage, null, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(_component_gadget_toast_notify),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BrTZuPse.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CaP427cz.mjs'));
...
export { ConfirmationEventBus as A, BaseStyle as B, ConnectedOverlayScrollHandler as C, DynamicDialogEventBus as D, script$6 as E, FilterMatchMode as F, script$5 as G, Ripple as R, Tooltip as T, _export_sfc as _, __nuxt_component_0 as a, useI18n as b, useNuxtApp as c, useRuntimeConfig as d, entry_default as default, useRouter as e, encodeRoutePath as f, nuxtLinkDefaults as g, script$9 as h, BaseDirective as i, useToast as j, storages as k, script$8 as l, script$4 as m, navigateTo as n, script$7 as o, FilterService as p, FilterOperator as q, resolveRouteObject as r, script$a as s, getVNodeProp as t, useHead as u, _default as v, useCookie as w, useRoute as x, defineNuxtRouteMiddleware as y, script$3 as z };
