...
const rates_post = defineEventHandler(async (event) => {
  ...
  const response = payload.success ? await api(config.private.api.setting.rates, {
    method: "POST",
    body: {
  ...
  if (response) {
    ...
    output = response == null ? void 0 : response.data.map((rate) => {
      return {
...
export { rates_post as default };
//# sourceMappingURL=rates.post.mjs.map
