...
const setting_post = defineEventHandler(async (event) => {
  ...
  if (response) {
    if (String(response == null ? void 0 : response.pesake.code).length > 0) {
      ...
      output = {
        countries: response == null ? void 0 : response.data.authorizedCountries.map(
          (country) => {
            return {
        ...
        files: {
          company: response == null ? void 0 : response.data.beneficialConfig.MORALE.map(
            (file) => {
              return {
                insertId: file.docId,
          ...
          individual: response == null ? void 0 : response.data.beneficialConfig.PHYSIQUE.map(
            (file) => {
              return {
                insertId: file.docId,
                category: file.docCat,
