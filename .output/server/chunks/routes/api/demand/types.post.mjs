import { d as defineEventHandler, u as useRuntimeConfig, r as readBody, l as loadLocale, f as fetch, a as readValidatedBody, c as createError, y as saveTransferTypes, e as errorMap } from '../../../_/nitro.mjs';
...
const types_post = defineEventHandler(async (event) => {
  ...
  const response = payload.success ? await api(config.private.api.transfer.types, {
    method: "POST",
    body: {
  ...
  if (response) {
    if (String(response == null ? void 0 : response.pesake.code).length > 0) {
      ...
      output = await saveTransferTypes(response == null ? void 0 : response.data);
    }
  }
  return {
...
export { types_post as default };
//# sourceMappingURL=types.post.mjs.map
