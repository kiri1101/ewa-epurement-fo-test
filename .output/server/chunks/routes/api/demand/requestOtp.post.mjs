import { d as defineEventHandler, u as useRuntimeConfig, r as readBody, l as loadLocale, f as fetch, a as readValidatedBody, c as createError, q as updateTransferOtp, e as errorMap } from '../../../_/nitro.mjs';
...
const requestOtp_post = defineEventHandler(async (event) => {
  ...
  const response = payload.success ? await api(config.private.api.transfer.otp.request, {
    method: "POST",
    body: {
  ...
  if (response) {
    ...
    if (String(response == null ? void 0 : response.pesake.code).length > 0) {
      ...
      if ((_a = payload.data) == null ? void 0 : _a.fileCode) {
        await updateTransferOtp(
          (_b = payload.data) == null ? void 0 : _b.fileCode,
...
//# sourceMappingURL=requestOtp.post.mjs.map
