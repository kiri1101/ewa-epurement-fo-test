import { d as defineEventHandler, u as useRuntimeConfig, r as readBody, l as loadLocale, a as readValidatedBody, t as searchTransfers, e as errorMap } from '../../../_/nitro.mjs';
...
const search_post = defineEventHandler(async (event) => {
  ...
  let output = payload.success ? await searchTransfers(payload.data.searchIndex) : null;
  return {
