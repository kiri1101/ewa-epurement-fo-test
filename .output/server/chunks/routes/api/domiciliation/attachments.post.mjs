...
const attachments_post = defineEventHandler(async (event) => {
  ...
  const response = payload.success ? await api(config.private.api.domiciliation.attachments, {
    method: "POST",
    body: {
  ...
  if (response) {
    if (String(response == null ? void 0 : response.pesake.code).length > 0) {
      ...
      output = response == null ? void 0 : response.data.map((attachment) => {
        return {
...
export { attachments_post as default };
//# sourceMappingURL=attachments.post.mjs.map
