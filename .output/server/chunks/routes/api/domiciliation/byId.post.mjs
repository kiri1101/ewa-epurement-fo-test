...
const byId_post = defineEventHandler(async (event) => {
  ...
  const response = payload.success ? await api(config.private.api.domiciliation.detail, {
    method: "POST",
    body: {
...
export { byId_post as default };
//# sourceMappingURL=byId.post.mjs.map
